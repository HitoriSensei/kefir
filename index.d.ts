...
export class Observable<T, S> {
    ...
    skipUntilBy<U, V>(otherObs: Observable<any, any>): Observable<T, S>;
    takeUntilBy(otherObs: Observable<any, any>): Observable<T, S>;
    bufferBy(otherObs: Observable<any, any>, options?: { flushOnEnd: boolean }): Observable<T[], S>;
    bufferWhileBy(otherObs: Observable<boolean, any>, options?: { flushOnEnd?: boolean, flushOnChange?: boolean }): Observable<T[], S>;
...
export function fromEvents<T>(target: EventTarget | NodeJS.EventEmitter | { on: Function, off: Function }, eventName: string): Stream<T, never>;
export function fromEvents<T, S>(target: EventTarget | NodeJS.EventEmitter | { on: Function, off: Function }, eventName: string, transform: (value: T) => S): Stream<S, never>;
...
// Combine observables
export function combine<T extends { [name: string]: Observable<any, any> }, U>(obss: T, combinator: (value: { [P in keyof T]: ValueOfAnObservable<T[P]> }) => U): Stream<U, any>;
export function combine<T extends { [name: string]: Observable<any, any> }>(obss: T): Stream<{ [P in keyof T]: ValueOfAnObservable<T[P]> }, any>;
export function combine<T extends { [name: string]: Observable<any, any> }, TP extends { [name: string]: Observable<any, any> }, U>(obss: T, combinator: (value: { [P in keyof T]: ValueOfAnObservable<T[P]> } & { [P in keyof TP]: ValueOfAnObservable<TP[P]> }) => U): Stream<U, any>;
export function combine<T extends { [name: string]: Observable<any, any> }, TP extends { [name: string]: Observable<any, any> }>(obss: T): Stream<{ [P in keyof T]: ValueOfAnObservable<T[P]> } & { [P in keyof TP]: ValueOfAnObservable<TP[P]> }, any>;

export function combine<W, T extends [Observable<any, any>, Observable<any, any>, Observable<any, any>, Observable<any, any>]>(obss: T, comb: (v1: ValueOfAnObservable<T[0]>, v2: ValueOfAnObservable<T[1]>, v3: ValueOfAnObservable<T[2]>, v4: ValueOfAnObservable<T[3]>) => W): Stream<W, any>;
...
export function combine<W, T extends [Observable<any, any>, Observable<any, any>, Observable<any, any>]>(obss: T, comb: (v1: ValueOfAnObservable<T[0]>, v2: ValueOfAnObservable<T[1]>, v3: ValueOfAnObservable<T[2]>) => W): Stream<W, any>;
...
export function combine<T extends [Observable<any, any>, Observable<any, any>], TP extends [Observable<any, any>]>(obss: T, passiveObss: TP): Stream<[ValueOfAnObservable<T[0]>, ValueOfAnObservable<T[1]>, ValueOfAnObservable<TP[0]>], any>;
export function combine<U, T extends [Observable<any, any>, Observable<any, any>], TP extends [Observable<any, any>]>(obss: T, passiveObss: TP, combinator: (value: [ValueOfAnObservable<T[0]>, ValueOfAnObservable<T[1]>, ValueOfAnObservable<TP[0]>]) => U): Stream<U, any>;
export function combine<W, T extends [Observable<any, any>, Observable<any, any>]>(obss: T, comb: (v1: ValueOfAnObservable<T[0]>, v2: ValueOfAnObservable<T[1]>) => W): Stream<W, any>;
...
export function combine<W, T extends [Observable<any, any>]>(obss: T, comb: (v1: ValueOfAnObservable<T[0]>) => W): Stream<W, any>;
...
export function combine<T, S, U>(obss: Observable<T, S>[], passiveObss: Observable<T, S>[]): Stream<T[], S>;
export function combine<T, S, U>(obss: Observable<T, S>[], combinator: (...values: T[]) => U): Stream<U, S>;
export function combine<T, S, U>(obss: Observable<T, S>[]): Stream<T[], S>;
export function combine<T extends[Observable<any, any>], P extends [Observable<any, any>], K>(obss: T, obssP: P, combinator: (a1: ValueOfAnObservable<T[0]>, p1: ValueOfAnObservable<P[0]>) => K): Observable<K, any>;
export function combine<T extends[Observable<any, any>], P extends [Observable<any, any>, Observable<any, any>], K>(obss: T, obssP: P): Observable<[ValueOfAnObservable<T[0]>, ValueOfAnObservable<P[0]>, ValueOfAnObservable<P[1]>], any>;
export function combine<T extends[Observable<any, any>], P extends [Observable<any, any>, Observable<any, any>], K>(obss: T, obssP: P, combinator: (a1: ValueOfAnObservable<T[0]>, p1: ValueOfAnObservable<P[0]>, p2: ValueOfAnObservable<P[1]>) => K): Observable<K, any>;
