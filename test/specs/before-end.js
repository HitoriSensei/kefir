...
describe("beforeEnd", () => {
  describe("stream", () => {
    ...
    it("should be ended if source was ended", () => {
      expect(send(stream(), [end()]).beforeEnd(() => 42)).to.emit([
    ...
    it("should handle events", () => {
      const a = stream();
      expect(a.beforeEnd(() => 42)).to.emit(
        [value(1), value(2), value(42), end()],
  ...
  describe("property", () => {
    ...
    it("should be ended if source was ended", () => {
      expect(send(prop(), [end()]).beforeEnd(() => 42)).to.emit([
        value(42, { current: true }),
        end({ current: true })
      ]);
    ...
    it("should handle events and current", () => {
      ...
      expect(a.beforeEnd(() => 42)).to.emit(
        [value(1, { current: true }), value(2), value(3), value(42), end()],
