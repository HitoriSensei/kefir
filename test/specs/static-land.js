...
describe("Kefir.staticLand.Observable", () => {
  it("of works", () => {
    expect(Observable.of(2)).to.emit([
  ...
  it("map works", () => {
    expect(Observable.map(x => x * 3, Observable.of(2))).to.emit([
  ...
  it("bimap works", () => {
    ...
    expect(
      Observable.bimap(x => x * 3, x => x, Kefir.constantError(2))
  ...
  it("chain works", () => {
    expect(
      Observable.chain(x => Observable.of(x * 3), Observable.of(2))
