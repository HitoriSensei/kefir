...
describe("ignoreEnd", () => {
  describe("stream", () => {
    ...
    it("should handle events", () => {
      const a = stream();
      expect(a.ignoreEnd()).to.emit([value(1), value(2)], () =>
  ...
  describe("property", () => {
    ...
    it("should not be ended if source was ended", () => {
      ...
      expect(send(prop(), [value(1), end()]).ignoreEnd()).to.emit([
    ...
    it("should handle events and current", () => {
      ...
      expect(a.ignoreEnd()).to.emit(
        [value(1, { current: true }), value(2), value(3)],
