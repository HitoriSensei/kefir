...
describe("take", () => {
  describe("stream", () => {
    ...
    it("should handle events (less than `n`)", () => {
      const a = stream();
      expect(a.take(3)).to.emit([value(1), value(2), end()], () =>
  ...
  describe("property", () => {
    it("should return property", () =>
      expect(prop().take(3)).to.be.observable.property());
    ...
    it("should work correctly with .constant", () =>
      expect(Kefir.constant(1).take(1)).to.emit([
