...
import combineIntermediate from "./many-sources/combine";
Observable.prototype.combineIntermediate = function(other, combinator) {
  return combineIntermediate([this, other], combinator);
};
...
Observable.prototype.flatMapLatest = function(fn) {
  return new FlatMap(this, fn, { concurLim: 1, drop: "old" }).setName(
    this,
    "flatMapLatest"
  );
};
...
Observable.prototype.flatMapConcat = function(fn) {
  return new FlatMap(this, fn, { queueLim: -1, concurLim: 1 }).setName(
    this,
    "flatMapConcat"
  );
};
Observable.prototype.flatMapConcurLimit = function(fn, limit) {
  return new FlatMap(this, fn, { queueLim: -1, concurLim: limit }).setName(
    this,
    "flatMapConcurLimit"
  );
};
